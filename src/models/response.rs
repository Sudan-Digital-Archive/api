...
pub struct AccessionsWithMetadataResponse {
    ...
    pub contributor_role_en_ids: Vec<i32>,
    ...
    pub contributor_role_ar_ids: Vec<i32>,
...
impl From<AccessionsWithMetadataModel> for AccessionsWithMetadataResponse {
    fn from(model: AccessionsWithMetadataModel) -> Self {
        Self {
            ...
            location_en_id: model.location_en_id,
            creator_en_id: model.creator_en_id,
            creator_en: model.creator_en,
            subjects_en: model.subjects_en,
            subjects_en_ids: model.subjects_en_ids,
            contributors_en: model.contributors_en,
            ...
            location_ar_id: model.location_ar_id,
            creator_ar_id: model.creator_ar_id,
            creator_ar: model.creator_ar,
            subjects_ar: model.subjects_ar,
            subjects_ar_ids: model.subjects_ar_ids,
            contributors_ar: model.contributors_ar,
